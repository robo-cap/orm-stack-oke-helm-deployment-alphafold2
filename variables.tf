...
variable "cidr_fss_subnet" {
  type        = string
  default     = "10.0.0.16/29"
  description = "The IPv4 CIDR block to be used for the fss subnet."
}
...
variable "deploy_nim" {
  type        = bool
  default     = true
  description = "Controls the deployment of the NIM AlphaFold2 helm chart."
}

variable "nim_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the NIM AlphaFold2 helm chart defaults and those generated by Terraform using the templates."
}
...
variable "jupyter_playbooks_repo" {
  type        = string
  default     = "https://github.com/robo-cap/alphafold2-jupyter-notebooks.git"
...
variable "nim_image_repository" {
  type        = string
  default     = "nvcr.io/nim/deepmind/alphafold2"
